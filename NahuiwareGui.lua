...
local library = utility.table({theme = table.clone(themes.Nahuiware), folder = "Nahuiware v1.2", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "nahuiware"}
...
function library:Load(options)
	...
	local name = "Nahuiware v1.2"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Nahuiware"
